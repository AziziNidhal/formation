...
use Admin\AdminBundle\Entity\Etudiant;
...
class EtudiantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $etudiants = $em->getRepository('AdminBundle:Etudiant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\AdminBundle\Form\EtudiantType', $etudiant);
    ...
    {
        $deleteForm = $this->createDeleteForm($etudiant);
        $editForm = $this->createForm('Admin\AdminBundle\Form\EtudiantType', $etudiant);
