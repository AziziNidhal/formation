 ...
 */
class Etudiant extends \Admin\AdminBundle\Entity\Etudiant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Etudiant' . "\0" . 'id', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Etudiant' . "\0" . 'nom', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Etudiant' . "\0" . 'prenom', '' . "\0" . 'Admin\\AdminBundle\\Entity\\Etudiant' . "\0" . 'naissance'];
        }
